                ...
                <View>
                  { screenType == 'deviceScreen' ?
                    <LinearGradient
                      ...
                      <Text style={styles.activeBtnText}>Installés</Text>
                    </LinearGradient>
                    :
                    <Text style={styles.btnText}>Installés</Text>
                  }
                </View>
              </TouchableHighlight> 
              <TouchableHighlight 
                ...
                <View>
                  { screenType == 'typeScreen' ?
                    <LinearGradient
                      ...
                      colors={blueGradient.colors}
                      style={styles.activeChildCircle}>
                      <Text style={styles.activeBtnText}>Non installés</Text>
                    </LinearGradient>
                    :
                    <Text style={styles.btnText}>Non installés</Text>
                  }
                </View>
              </TouchableHighlight>
            </View>
